...
@Component({
  ...
  <ion-header class="ion-no-border components-background-dark">
    <ion-toolbar class="components-background-dark">
      <ion-title class="text-color-dark">{{ '' }}</ion-title>
      <ion-buttons class="text-color-dark" slot="end">
        <ion-button class="ion-button-close" (click)="dismiss()"><ion-icon fill="clear" class="text-color-dark" name="close-outline"></ion-icon></ion-button>
      </ion-buttons>
    </ion-toolbar>
  </ion-header>

  <ion-content [fullscreen]="true" [scrollEvents]="true" >
    <div class="container components-color-second text-color-dark">
